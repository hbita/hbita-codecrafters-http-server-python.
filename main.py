...
import os
import gzip
# http server implemntation powered by 
# https://app.codecrafters.io/courses/http-server/extension-completed/http-compression?repo=80f6e664-a4f5-4ae4-a24d-494679d1c5e3
